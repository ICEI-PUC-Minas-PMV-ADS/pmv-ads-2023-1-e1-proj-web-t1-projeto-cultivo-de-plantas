...
function addInitialCommentsForPlant(plantName) {
  const initialComments = [
    { name: 'Isabella', comment: 'Minha espada-de-são-jorge está resistente e cheia de vida.' },
  { name: 'Gabriel99', comment: 'As folhas da minha espada-de-são-jorge têm um padrão incrível.' },
  { name: 'Laura', comment: 'A espada-de-são-jorge é perfeita para purificar o ar em ambientes fechados.' },
  { name: 'Matheus', comment: 'Estou pensando em dividir minha espada-de-são-jorge e fazer novas mudas.' },
  { name: 'Sophie@123', comment: 'A espada-de-são-jorge é uma planta fácil de cuidar, ideal para iniciantes.' },
  ];
...
submitButton.addEventListener('click', function() {
  ...
  if (commentText.length >= 10) {
    ...
    const plantName = 'Espada'; // Nome da planta específica
